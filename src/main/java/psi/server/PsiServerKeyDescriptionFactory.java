...
public class PsiServerKeyDescriptionFactory {
    ...
    public static PsiServerKeyDescription createBsServerKeyDescription(String privateKey, String publicKey, String modulus){
        return createBsServerKeyDescription(privateKey, publicKey, modulus, null);
    }

    public static PsiServerKeyDescription createBsServerKeyDescription(String privateKey, String publicKey, String modulus, Long keyId){
        ...
        if(keyId != null)
            psiServerKeyDescription.setKeyId(keyId);
