...
/**
 * Cache object used to store the result of the mathematical operations performed in ECDH and ECBS algorithms (excluding
 * the random value generated by the client when loading its dataset).
 */
